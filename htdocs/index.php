...
?>
						...
						<div class="row">
							<div class="col-md-4">
								...
								<ul class="fa-ul">
									...
									<li><i class="fa-li fa fa-user"></i>Vincent White - Windows exectuable <br />vincent@battlefieldtools.com</li>
						...
						<ul class="fa-ul">
							...
							<li><i class="fa-li fa fa-group"></i>Apache Friends &amp; Xampp</i></li>
							<br />
