...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['server_ip']) && isset($_POST['server_port']) && isset($_POST['rcon_pass']) && isset($_POST['name']) && isset($_POST['profile_id']) && isset($_POST['username']) && isset($_POST['pass'])) {
	...
	if(count($errors) == 0) {
		...
		if($db->multi_query($sql)) {
			$status = '<div class="alert alert-success alert-block"><h4><i class="fa fa-check"></i> Success!</h4><p>Installation succesful, please delete install.php and SQL.TXT from the htdocs folder<br /><br /><a href="' . HOME_URL . '">Continue &raquo;</a></p></div>';
		} else {
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					...
					<h3 class="text-muted center">For Windows</h3>
					<hr />
