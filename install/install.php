...
//// Vogelgesang 28.12.2005 => Old Section for addon functality end here
	...
	if ($xamppinstaller == "newpath") {
		...
		while ($BS == "0") {
			echo "\n  Do you want to reinstall the servertool and XAMPP installation?\n";
			echo "  1) Reinstall now in this new path\n";
			echo "  x) Exit\n";

			switch (trim(fgets(NEWSTDIN, 256))) { // Fix by Wiedmann
				case 1:
					$BS = 1;
					echo "\r\n  BattlefieldTools.com servertool and XAMPP is reinstalling now in your new directory...\r\n";
					sleep(1);
					break;
	...
	if (($xamppinstaller == "newinstall") || ($BS == 1) || ($updatemake == "makenew") || ($updatemake == "doppelt")) {
      ...
      // echo "DEBUG: Working with $awkconfig now ... \r\n";
		...
		echo "\r\n  ##### !!!IMPORTANT!!! #####\r\n\r\n\r\n";
		echo "\r\n  ##### Make sure to run start_servertool.bat to start your brand new servertool installation! #####\r\n\r\n\r\n";
		sleep(1);
	}
	...
	if (($updatemake == "nothingtodo") && ($xamppinstaller == "nothingtodo") && (($CS < 1) || ($CS == ""))) {
		echo "\r\n\r\n You are in a good position to setup your tool. run start_servertool and then visit http://localhost/install.php in your webbrowser to begin.\r\n\r\n\r\n";
	}
