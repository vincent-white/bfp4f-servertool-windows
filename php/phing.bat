...
SET phpCli=C:\Users\Whelpton\Documents\GitHub\bfp4f-servertool-windows\php\.\php.exe
...
"%phpCli%" -d html_errors=off -qC "C:\Users\Whelpton\Documents\GitHub\bfp4f-servertool-windows\php\pear\phing.php" %*
GOTO :EOF
