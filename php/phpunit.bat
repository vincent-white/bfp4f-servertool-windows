...
if "%PHPBIN%" == "" set PHPBIN=C:\Users\Whelpton\Documents\GitHub\bfp4f-servertool-windows\php\.\php.exe
if not exist "%PHPBIN%" if "%PHP_PEAR_PHP_BIN%" neq "" goto USE_PEAR_PATH
GOTO RUN
:USE_PEAR_PATH
set PHPBIN=%PHP_PEAR_PHP_BIN%
:RUN
"%PHPBIN%" "C:\Users\Whelpton\Documents\GitHub\bfp4f-servertool-windows\php\phpunit" %*
