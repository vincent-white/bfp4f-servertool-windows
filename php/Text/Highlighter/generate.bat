...
GOTO doshift
:noshift
C:\Users\Whelpton\Documents\GitHub\bfp4f-servertool-windows\php\.\php.exe -q -d output_buffering=1 -d include_path="\xampp\php\pear" \xampp\php/Text/Highlighter/generate.bat %MHL_PARAMS%
